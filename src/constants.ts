export const API_ROUTES_ROOT = "/api/v1";

// page titles
export const HOME_PAGE_TITLE = "Zachary Metz.com";
export const HOME_PAGE_DESCRIPTION = "Zachary Metz's personal website";
export const ABOUT_PAGE_TITLE = "About Zachary Metz";
